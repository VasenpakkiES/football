...
<h2> Eero Siljanderin Kukka & Ruukkukauppa, (www-sivut, 10.9.2024) </h2>
    ...
    <section id="featured">
        ...
        <div class="featured-container">
            ...
            <div class="featured-item">
                <img src="C:\Users\EeronPc\Desktop\VScode\sunflowers.jpg" alt="Sunflowers">
                <h3>Sunflowers</h3>
            ...
            <div class="featured-item">
                <img src="C:\Users\EeronPc\Desktop\VScode\daisies.jpg" alt="Daisies">
                <h3>Daisies</h3>
    ...
    <section id="promotions">
        <div class="promotion">
            ...
            <button class="promo-button" onclick="window.location.href='shop.html'">Shop Now</button>
        </div>
        <div class="promotion">
            <h3>Free Delivery</h3>
            ...
            <button class="promo-button" onclick="window.location.href='shop.html'">Order Now</button>
        </div>
    </section>
</main>
